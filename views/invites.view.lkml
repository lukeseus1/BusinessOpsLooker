view: invites {
  sql_table_name: `analytics.invites`
    ;;
  ...
  dimension: entity_create_template {
    type: yesno
    description: "entityCreateTemplate"
    sql: ${TABLE}.entityCreateTemplate ;;
  }
...
view: invites__entities {
  ...
  dimension: invites__entities {
    type: string
    description: "entities"
    hidden: yes
    sql: invites__entities ;;
  }
...
view: invites____error__ {
  dimension: invites____error__ {
    type: string
    sql: invites____error__ ;;
  }
}

view: invites__permissions {
  dimension: invites__permissions {
    type: string
    description: "permissions"
    sql: invites__permissions ;;
  }
}

view: invites__daily_digests {
  drill_fields: [id]
  ...
  dimension: invites__daily_digests {
    type: string
    description: "dailyDigests"
    hidden: yes
    sql: invites__daily_digests ;;
  }
...
view: invites__organizations {
  ...
  dimension: invites__organizations {
    type: string
    description: "organizations"
    hidden: yes
    sql: invites__organizations ;;
  }
...
view: invites__user_notifications {
  dimension: invites__user_notifications {
    type: number
    description: "userNotifications"
    sql: invites__user_notifications ;;
  }
}

view: invites__enrichment__gravatar__urls {
  dimension: __key____app {
    type: string
    sql: ${TABLE}.__key__.app ;;
    group_label: "Key"
...
view: invites__enrichment__gravatar__avatars {
  dimension: __key____app {
    type: string
    sql: ${TABLE}.__key__.app ;;
    group_label: "Key"
