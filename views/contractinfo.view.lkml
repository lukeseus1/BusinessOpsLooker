  ...
  derived_table: {
    sql: WITH firstCommitementPeriod AS (
      ...
      SELECT
          ...
          ent.country,
          cust.enrichment.geo.countryCode as CountryCode,
          con.type,
          ...
          sum(comm.firstPeriodContractCommit+comm.secondPeriodContractCommit+comm.thirdPeriodContractCommit+comm.fourthPeriodContractCommit+comm.fifthPeriodContractCommit) as TCV,
